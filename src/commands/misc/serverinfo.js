...
class Serverinfo extends Command {
    ...
    constructor(client) {
        super(client, {
            name: "serverinfo",
            description: "misc/serverinfo:general:description",
            dirname: __dirname,
    ...
    async run(interaction, message, args, data){
        ...
        let embed = new MessageEmbed()
            ...
            .addField(guild.translate("misc/serverinfo:main:fields:name:name")
                    .replace('{emotes.pencil}', this.client.emotes.pencil),
                guild.translate("misc/serverinfo:main:fields:name:value")
                    .replace('{guildName}', guild.name), true)

            .addField(guild.translate("misc/serverinfo:main:fields:id:name")
                    .replace('{emotes.id}', this.client.emotes.id),
                guild.translate("misc/serverinfo:main:fields:id:value")
                    .replace('{guildId}', guild.id), true)

            .addField(guild.translate("misc/serverinfo:main:fields:owner:name")
                    .replace('{emotes.crown}', this.client.emotes.crown),
                guild.translate("misc/serverinfo:main:fields:owner:value")
                    .replace('{guildOwner}', owner.user.tag))

            .addField(guild.translate("misc/serverinfo:main:fields:members:name")
                    .replace('{emotes.people}', this.client.emotes.members),
                guild.translate("misc/serverinfo:main:fields:members:value")
            ...
            .addField(guild.translate("misc/serverinfo:main:fields:createdAt:name")
                    .replace('{emotes.calendar}', this.client.emotes.calendar),
                guild.translate("misc/serverinfo:main:fields:createdAt:value")
                    .replace('{createdAt}', createdDate))

            .addField(guild.translate("misc/serverinfo:main:fields:createdBefore:name")
                    .replace('{emotes.calendar}', this.client.emotes.calendar),
                guild.translate("misc/serverinfo:main:fields:createdBefore:value")
            ...
            .addField(guild.translate("misc/serverinfo:main:fields:boostsUntil:name")
                    ...
                    .replace('{level}', guild.premiumTier
                        ...
                        .replace('TIER_2', '3')
                        .replace('TIER_3', '3')),
                guild.translate("misc/serverinfo:main:fields:boostsUntil:value")
