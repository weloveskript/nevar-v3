...
class Join2create extends Command {
    ...
    constructor(client) {
        super(client, {
            name: "join2create",
            description: "administration/join2create:general:description",
            dirname: __dirname,
    ...
    async run(interaction, message, args, data) {
        ...
        let row = new MessageActionRow()
            .addComponents(
                new MessageButton()
                    ...
                    .setLabel(guild.translate("administration/join2create:main:actions:1"))
                    .setEmoji('✏️')
                    .setStyle('PRIMARY'),
                new MessageButton()
                    .setCustomId('join2create_' + id + '_show')
                    .setLabel(guild.translate("administration/join2create:main:actions:2"))
                    .setEmoji('📝')
                    .setDisabled(data.guild.plugins.joinToCreate.enabled === false)
                    .setStyle('PRIMARY'),
                new MessageButton()
                    .setCustomId('join2create_' + id + '_disable')
                    .setLabel(guild.translate("administration/join2create:main:actions:3"))
                    .setEmoji('❌')
                    .setDisabled(data.guild.plugins.joinToCreate.enabled === false)
                    .setStyle('DANGER'),
            )
        ...
        if (clicked) {
            if (clicked.customId === 'join2create_' + id + '_edit') {
                let embed = new MessageEmbed()
                    .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                    .setDescription(guild.translate("administration/join2create:main:collectors:channel")
                        .replace('{emotes.arrow}', this.client.emotes.arrow))
                    .setColor(this.client.embedColor)
                    .setFooter({text: data.guild.footer});
                ...
                collectChannel.on("collect", async (msg) => {
                    ...
                    if (!channelSent) {
                        ...
                        let embed = new MessageEmbed()
                            .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                            .setDescription(guild.translate("administration/join2create:main:collectors:userlimit")
                                .replace('{emotes.arrow}', this.client.emotes.arrow))
                            .setColor(this.client.embedColor)
                            .setFooter({text: data.guild.footer});
                        ...
                        collectUserlimit.on("collect", async (msg) => {
                            ...
                            if (userlimit && (userlimit >= 1 && userlimit <= 99) || userlimit === -1) {
                                let embed = new MessageEmbed()
                                    .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                                    .setDescription(guild.translate("administration/join2create:main:collectors:bitrate")
                                        .replace('{emotes.arrow}', this.client.emotes.arrow))
                                    .setColor(this.client.embedColor)
                                    .setFooter({text: data.guild.footer});
                                await sent.edit({embeds: [embed]});
                                ...
                                collectBitrate.on("collect", async (msg) => {
                                    ...
                                    if (bitrate >= 8 && bitrate <= 96) {
                                        ...
                                        let embed = new MessageEmbed()
                                            .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                                            .setDescription(guild.translate("administration/join2create:main:set")
                                        ...
                                        let embed = new MessageEmbed()
                                            .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                                            .setDescription(guild.translate("administration/join2create:main:invalid:bitrate")
                                                .replace('{emotes.error}', this.client.emotes.error))
                                            .setColor(this.client.embedColor)
                                            .setFooter({text: data.guild.footer});
                                        return sent.edit({embeds: [embed]});
                                ...
                                let embed = new MessageEmbed()
                                    .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                                    .setDescription(guild.translate("administration/join2create:main:invalid:userlimit")
                                        .replace('{emotes.error}', this.client.emotes.error))
                                    .setColor(this.client.embedColor)
                                    .setFooter({text: data.guild.footer});
                                return sent.edit({embeds: [embed]});
            ...
            if (clicked.customId === 'join2create_' + id + '_show') {
                ...
                let embed = new MessageEmbed()
                    .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                    .setDescription(guild.translate("administration/join2create:main:show")
                        .replace('{emotes.arrow}', this.client.emotes.arrow)
            ...
            if (clicked.customId === 'join2create_' + id + '_disable') {
                ...
                let embed = new MessageEmbed()
                    .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                    .setDescription(guild.translate("administration/join2create:main:disabled")
                        .replace('{emotes.success}', this.client.emotes.success))
                    .setColor(this.client.embedColor)
                    .setFooter({text: data.guild.footer});
                await clicked.update({embeds: [embed], components: []})
