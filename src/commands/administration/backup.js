...
class Backup extends Command {
    constructor(client) {
        super(client, {
            name: "backup",
            description: "administration/backup:general:description",
            dirname: __dirname,
        ...
        let row = new MessageActionRow()
            .addComponents(
                new MessageButton()
                    ...
                    .setLabel(guild.translate("administration/backup:main:actions:1"))
                    .setEmoji('➕')
                    .setStyle('SUCCESS'),
                new MessageButton()
                    .setCustomId('backup_' + id + '_info')
                    .setLabel(guild.translate("administration/backup:main:actions:2"))
                    .setEmoji('💾')
                    .setStyle('PRIMARY'),
                new MessageButton()
                    .setCustomId('backup_' + id + '_load')
                    .setLabel(guild.translate("administration/backup:main:actions:3"))
                    .setEmoji('⌛')
                    .setStyle('PRIMARY'),
            )
        let sent;
        ...
        if (clicked) {
            if (clicked.customId === 'backup_' + id + '_create') {
                ...
                await backups.create(guild, options).then(async (backup) => {
                    let embed = new MessageEmbed()
                        .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                        .setDescription(guild.translate("administration/backup:main:created:private")
                    ...
                    let embed2 = new MessageEmbed()
                        .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                        .setDescription(guild.translate("administration/backup:main:created:guild")
                            .replace('{emotes.success}', this.client.emotes.success))
                        .setColor(this.client.embedColor)
                        .setFooter({text: data.guild.footer});
                    ...
                    await user.send({embeds: [embed]}).catch(() => {
                        ...
                        let embed3 = new MessageEmbed()
                            .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                            .setDescription(guild.translate("administration/backup:main:created:cannotDm")
            ...
            if (clicked.customId === 'backup_' + id + '_info') {
                let embed = new MessageEmbed()
                    .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                    .setDescription(guild.translate("language:collectors:id")
                        .replace('{emotes.arrow}', this.client.emotes.arrow))
                    .setColor(this.client.embedColor)
                    .setFooter({text: data.guild.footer});
                await clicked.update({embeds: [embed], components: []});
                ...
                collectMessage.on("collect", async (msg) => {
                    ...
                    backups.fetch(msg.content).then(async (backupData) => {
                        ...
                        let embed = new MessageEmbed()
                            .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                            .setDescription(guild.translate("administration/backup:main:info")
                        ...
                        .catch(() => {
                            let embed = new MessageEmbed()
                                .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                                .setDescription(guild.translate("administration/backup:main:notFound")
                                    .replace('{emotes.error}', this.client.emotes.error))
                                .setColor(this.client.embedColor)
                                .setFooter({text: data.guild.footer});
                            return sent.edit({embeds: [embed]});
            ...
            if (clicked.customId === 'backup_' + id + '_load') {
                ...
                collectMessage.on("collect", async (msg) => {
                    ...
                    backups.fetch(msg.content).then(async () => {
                        let embed = new MessageEmbed()
                            .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                            .setDescription(guild.translate("administration/backup:main:load")
                                .replace('{emotes.loading}', this.client.emotes.loading))
                            .setColor(this.client.embedColor)
                            .setFooter({text: data.guild.footer});
