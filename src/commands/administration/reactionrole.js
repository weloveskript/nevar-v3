...
class Reactionrole extends Command {
    ...
    async run(interaction, message, args, data){
        ...
        let embed = new MessageEmbed()
            ...
            .setDescription(guild.translate("administration/reactionrole:main:collectors:id")
            ...
            if(isNaN(msg.content)){
                ...
                if(msg.content.length === 18){
                    channel.messages.fetch(msg.content).catch(async () => {
                        ...
                        let embed = new MessageEmbed()
                            .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                            .setDescription(guild.translate("administration/reactionrole:main:collectors:role")
                                .replace('{emotes.arrow}', this.client.emotes.arrow))
                            .setColor(this.client.embedColor)
                            .setFooter({text: data.guild.footer});
                        sent.edit({embeds: [embed]});
                        ...
                        collectRole.on("collect", async (msg) => {
                            ...
                            if(role){
                                let embed = new MessageEmbed()
                                    .setAuthor({name: this.client.user.username, iconURL: this.client.user.displayAvatarURL(), url: this.client.website})
                                    .setDescription(guild.translate("administration/reactionrole:main:collectors:emoji")
                                        .replace('{emotes.arrow}', this.client.emotes.arrow))
                                    .setColor(this.client.embedColor)
                                    .setFooter({text: data.guild.footer});
                                sent.edit({embeds: [embed]});
